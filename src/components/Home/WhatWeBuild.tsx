			...
			<div className="max-w-7xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					{categories.map((category, idx) => (
						<div
							key={idx}
							className="bg-[#0c0c24] border border-[#1c00d3]/40 rounded-2xl shadow-xl p-6 md:p-8 transition duration-300 hover:shadow-[#1c00d3]/50 hover:border-[#1c00d3]">
							<h3 className="text-2xl font-semibold text-[#1c00d3] mb-2">
								{category.title}
							</h3>
